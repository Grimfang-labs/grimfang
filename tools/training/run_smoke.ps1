...
$data = Join-Path $GrimfangRoot 'tools\data\train_shuffled.bulletdata'
...
$env:GRIMFANG_DATA = $data
$env:GRIMFANG_OUTPUT_DIR = 'checkpoints_smoke'
$env:GRIMFANG_END_SB = '1'
$env:GRIMFANG_THREADS = '4'
$env:GRIMFANG_BATCH_QUEUE = '64'
...
Write-Host "  checkpoint: $BulletRoot\checkpoints_smoke\grimfang-net-001-1\"
